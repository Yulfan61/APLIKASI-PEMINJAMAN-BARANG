...
class BorrowingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach ($users as $user) {
                ...
                // Kirim notifikasi WA via Venom API
                if ($user->phone_number) { // pastikan ada nomor
                    Http::post('http://localhost:3000/send-message', [
                        'number' => $user->phone_number, // format 628xxxx
    ...
    public function update(Request $request, Borrowing $borrowing)
    {
        ...
        DB::transaction(function () use ($borrowing, $validated) {
            ...
            // Jika Approved → status lain, kembalikan stok
            ...
            if ($validated['status'] === 'Approved' && $previousStatus !== 'Approved') {
                ...
                if ($user->phone_number) {
                    Http::post('http://localhost:3000/send-message', [
                        'number' => $user->phone_number, // format 628xxx
                        'message' => "✅ Peminjaman Anda telah *DISETUJUI* oleh admin.\n\n" .
                            "📅 Tanggal Pinjam: {$borrowing->borrow_date}\n" .
                            "📅 Tanggal Kembali: {$borrowing->return_date}\n" .
                            "📦 Jumlah Barang: " . $borrowing->items->sum('pivot.quantity') . "\n\n" .
            ...
            // Kirim notifikasi Laravel ke user
